...
static const _UWBPos_type_support_symbol_names_t _UWBPos_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vel_forwarder, msg, UWBPos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vel_forwarder, msg, UWBPos)),
  }
};
...
{
  return &::vel_forwarder::msg::rosidl_typesupport_cpp::UWBPos_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vel_forwarder, msg, UWBPos)() {
  return get_message_type_support_handle<vel_forwarder::msg::UWBPos>();
}
