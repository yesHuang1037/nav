...
static const _Vel_type_support_symbol_names_t _Vel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vel_forwarder, msg, Vel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vel_forwarder, msg, Vel)),
  }
};
...
{
  return &::vel_forwarder::msg::rosidl_typesupport_cpp::Vel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vel_forwarder, msg, Vel)() {
  return get_message_type_support_handle<vel_forwarder::msg::Vel>();
}
