...
#include "vel_forwarder/msg/detail/health__rosidl_typesupport_fastrtps_c.h"
...
using _Health__ros_msg_type = vel_forwarder__msg__Health;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: infantry1
  {
    cdr << ros_message->infantry1;
  }

  // Field name: infantry2
  {
...
size_t get_serialized_size_vel_forwarder__msg__Health(
  const void * untyped_ros_message,
...
static uint32_t _Health__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vel_forwarder__msg__Health(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vel_forwarder
size_t max_serialized_size_vel_forwarder__msg__Health(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vel_forwarder__msg__Health;
    is_plain =
      (
...
static size_t _Health__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vel_forwarder__msg__Health(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vel_forwarder, msg, Health)() {
