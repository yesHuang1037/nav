...
#include "vel_forwarder/msg/detail/vel__rosidl_typesupport_fastrtps_c.h"
...
using _Vel__ros_msg_type = vel_forwarder__msg__Vel;
...
size_t get_serialized_size_vel_forwarder__msg__Vel(
  const void * untyped_ros_message,
...
static uint32_t _Vel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vel_forwarder__msg__Vel(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vel_forwarder
size_t max_serialized_size_vel_forwarder__msg__Vel(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vel_forwarder__msg__Vel;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _Vel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vel_forwarder__msg__Vel(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vel_forwarder, msg, Vel)() {
